...
class MultiAttentionBlock(nn.Module):
    ...
    def forward(self, q, k, v, mask):
        ...
        x, self.attention_scores = MultiAttentionBlock.attention(query, key, value, mask, self.dropout)
...
class EncoderBlock(nn.Module):
    ...
    def __init__(self,self_attention_block:MultiAttentionBlock, feed_forward_block:FeedForwardBlock, dropout:float) -> None:
        super().__init__()
...
class DecoderBlock(nn.Module):
    ...
    def __init__(self, self_attention_block:MultiAttentionBlock, cross_attention_block:MultiAttentionBlock, feed_forward_block:FeedForwardBlock, dropout:float) -> None:
        super().__init__()
        self.self_attention_block = self_attention_block
